        ...
        <Modal show={props.show} onHide={props.handleClose}>
            ...
            <Modal.Body>
                ...
                <Container>
                    <Row>
                        <Col>
                            <p className="mensajeFinal" > Gracias por su compra, pronto un asesor comercial se comunicara con usted!</p>
            ...
            <Modal.Footer>
            { datos === false ?<Link to="#" className="btn btn-lg buttonAccent float-end" onClick={finalizarCompra}> Finalizar compra</Link>
